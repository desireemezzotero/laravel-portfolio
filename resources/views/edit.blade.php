...
<div class="bg-black h-screen ">
  ...
  <form class="max-w-md mx-auto pt-10 text-white" action="{{route('project.update', $project)}}" method="POST">
    ...
    <div class="relative z-0 w-full mb-5 group">
      ...
      <input name="technologies[]" id="tec-{{$technology->title_technology}}" type="checkbox" value="{{$technology->id}}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 focus:ring-2 " {{$project->technologies->contains($technology->id) ? 'checked' : ''}}> {{$technology->title_technology}}
       </input>
     @endforeach
